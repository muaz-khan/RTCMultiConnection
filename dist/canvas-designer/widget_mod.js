...
!(function () {
  ...
  function addEvent(element, eventType, callback) {
    if (!(eventType.split(" ").length > 1))
      return element.addEventListener
        ? (element.addEventListener(eventType, callback, !1), !0)
        : element.attachEvent
        ? element.attachEvent("on" + eventType, callback)
        : ((element["on" + eventType] = callback), this);
    for (var events = eventType.split(" "), i = 0; i < events.length; i++)
  ...
  function drawArrow(mx, my, lx, ly, options) {
    ...
    function handleOptions(opt, isNoFillStroke) {
      (opt = opt || getOptions()),
        ...
        (context.font = opt[7]),
        isNoFillStroke || (context.stroke(), context.fill());
    }
    var arrowSize = 10,
  ...
  function endLastPath() {
    ...
    cache.isArc
      ...
      ? quadraticHandler.end()
      : cache.isBezierCurve && bezierHandler.end(),
      drawHelper.redraw(),
      textHandler.text &&
        textHandler.text.length &&
        (textHandler.appendPoints(), textHandler.onShapeUnSelected()),
  ...
  function clone(obj) {
    if (null === obj || "object" != typeof obj || "isActiveClone" in obj)
      return obj;
  ...
  function setDefaultSelectedIcon() {
    for (
      var firstMatch,
        ...
        canvasElements = toolBox.getElementsByTagName("canvas"),
        shape = window.selectedIcon.toLowerCase(),
        i = 0;
      i < canvasElements.length;
      i++
    )
      firstMatch ||
        -1 === (canvasElements[i].id || "").indexOf(shape) ||
  ...
  function setTemporaryLine() {
    ...
    points.push(arr),
      ...
      setTimeout(setDefaultSelectedIcon, 2e3);
  }
  ...
  function onkeydown(e) {
    if (8 == (keyCode = e.which || e.keyCode || 0) || 46 == keyCode)
      return void isBackKey(e, keyCode);
    e.metaKey && ((isControlKeyPressed = !0), (keyCode = 17)),
      isControlKeyPressed || 17 !== keyCode || (isControlKeyPressed = !0);
  }
  ...
  function isBackKey(e, keyCode) {
    ...
    return (
      (doPrevent =
        (("INPUT" !== d.tagName.toUpperCase() ||
          ("TEXT" !== d.type.toUpperCase() &&
            "PASSWORD" !== d.type.toUpperCase() &&
            "FILE" !== d.type.toUpperCase() &&
            "SEARCH" !== d.type.toUpperCase() &&
            "EMAIL" !== d.type.toUpperCase() &&
            "NUMBER" !== d.type.toUpperCase() &&
            "DATE" !== d.type.toUpperCase())) &&
          "TEXTAREA" !== d.tagName.toUpperCase()) ||
        d.readOnly ||
        d.disabled),
      doPrevent && e.preventDefault(),
      doPrevent
    );
  }
  ...
  function onkeyup(e) {
    return (
      ...
      13 === (keyCode = e.which || e.keyCode || 0) && is.isText
        ? void textHandler.onReturnKeyPressed()
        : 8 == keyCode || 46 == keyCode
        ? void (
            isBackKey(e, keyCode) &&
            textHandler.writeText(textHandler.lastKeyPress, !0)
          )
        : isControlKeyPressed && 84 === keyCode && is.isText
        ? void textHandler.showTextTools()
        : (isControlKeyPressed &&
            90 === keyCode &&
            points.length &&
            ((points.length = points.length - 1),
            drawHelper.redraw(),
            syncPoints(!(!is.isDragAllPaths && !is.isDragLastPath))),
          isControlKeyPressed &&
            65 === keyCode &&
            ((dragHelper.global.startingIndex = 0),
            endLastPath(),
            setSelection(find("drag-all-paths"), "DragAllPaths")),
          isControlKeyPressed && 67 === keyCode && points.length && copy(),
          isControlKeyPressed &&
            86 === keyCode &&
            copiedStuff.length &&
            (paste(), syncPoints(!(!is.isDragAllPaths && !is.isDragLastPath))),
          void 0 !== e.metaKey &&
            !1 === e.metaKey &&
            ((isControlKeyPressed = !1), (keyCode = 17)),
  ...
  function onTextFromClipboard(e) {
    if (is.isText) {
      ...
      window.clipboardData && window.clipboardData.getData
        ...
        pastedText && pastedText.length && textHandler.writeText(pastedText);
    }
  }
  ...
  function syncPoints(isSyncAll) {
    if ((isSyncAll && (lastPointIndex = 0), lastPointIndex != points.length)) {
      ...
      pointsToShare.length &&
        syncData({
          points: pointsToShare || [],
          startIndex: lastPointIndex,
        }),
        (!pointsToShare.length && points.length) ||
  ...
  var isControlKeyPressed,
    is = {
      ...
      set: function (shape) {
        var cache = this;
        (cache.isLine = cache.isArrow = cache.isArc = cache.isDragLastPath = cache.isDragAllPaths = cache.isRectangle = cache.isQuadraticCurve = cache.isBezierCurve = cache.isPencil = cache.isMarker = cache.isEraser = cache.isText = cache.isImage = cache.isPdf = !1),
          (cache["is" + shape] = !0);
      },
    },
    points = [],
    ...
    common = {
      updateTextArea: function () {
        ...
        isAbsolutePoints && isShortenCode && c.absoluteShortened(),
          isAbsolutePoints && !isShortenCode && c.absoluteNOTShortened(toFixed),
          !isAbsolutePoints &&
            isShortenCode &&
      ...
      relativeShortened: function (toFixed, getPoint) {
        ...
        for (i; i < length; i++)
          (p = points[i]),
            (point = p[1]),
            0 === i && ((x = point[0]), (y = point[1])),
            "text" === p[0] && ((x = point[1]), (y = point[2])),
            "pencil" === p[0] &&
      ...
      strokeOrFill: function (p) {
        return this.prevProps && this.prevProps === p.join(",")
          ? "strokeOrFill();"
      ...
      shortenHelper: function (name, p1, p2) {
        ...
        return (
          (this.prevProps && this.prevProps === p2.join(",")) ||
    ...
    dragHelper = {
      ...
      mousedown: function (e) {
        ...
        if (
          ...
          var p = points[points.length - 1],
            point = p[1];
          "line" === p[0] &&
            (dHelper.isPointInPath(x, y, point[0], point[1]) &&
              (g.pointsToMove = "head"),
            dHelper.isPointInPath(x, y, point[2], point[3]) &&
              (g.pointsToMove = "tail")),
            "arrow" === p[0] &&
              (dHelper.isPointInPath(x, y, point[0], point[1]) &&
                (g.pointsToMove = "head"),
            ...
            "rect" === p[0] &&
              ...
              dHelper.isPointInPath(x, y, point[0] + point[2], point[1]) &&
                (g.pointsToMove = "stretch-second"),
              dHelper.isPointInPath(x, y, point[0], point[1] + point[3]) &&
            ...
            "image" === p[0] &&
              (dHelper.isPointInPath(x, y, point[1], point[2]) &&
                (g.pointsToMove = "stretch-first"),
              dHelper.isPointInPath(x, y, point[1] + point[3], point[2]) &&
                (g.pointsToMove = "stretch-second"),
              dHelper.isPointInPath(x, y, point[1], point[2] + point[4]) &&
                (g.pointsToMove = "stretch-third"),
              dHelper.isPointInPath(
                x,
                y,
            ...
            "quadratic" === p[0] &&
              ...
              dHelper.isPointInPath(x, y, point[4], point[5]) &&
            ...
            "bezier" === p[0] &&
              ...
              dHelper.isPointInPath(x, y, point[6], point[7]) &&
                (g.pointsToMove = "ending-points"));
        }
        g.ismousedown = !0;
      },
        ...
        if (points.length) {
          ...
          this.global.ismousedown
            ...
            "quadratic" === p[0] &&
              ...
              tempContext.arc(point[0], point[1], 10, 2 * Math.PI, 0, !1),
              tempContext.arc(point[2], point[3], 10, 2 * Math.PI, 0, !1),
              tempContext.arc(point[4], point[5], 10, 2 * Math.PI, 0, !1),
              tempContext.fill()),
            "bezier" === p[0] &&
              (tempContext.beginPath(),
              tempContext.arc(point[0], point[1], 10, 2 * Math.PI, 0, !1),
              tempContext.arc(point[2], point[3], 10, 2 * Math.PI, 0, !1),
              tempContext.arc(point[4], point[5], 10, 2 * Math.PI, 0, !1),
              tempContext.arc(point[6], point[7], 10, 2 * Math.PI, 0, !1),
              tempContext.fill()),
            "line" === p[0] &&
              (tempContext.beginPath(),
              tempContext.arc(point[0], point[1], 10, 2 * Math.PI, 0, !1),
            ...
            "image" === p[0] &&
              (tempContext.beginPath(),
              tempContext.arc(point[1], point[2], 10, 2 * Math.PI, 0, !1),
              tempContext.fill(),
              tempContext.beginPath(),
              tempContext.arc(
                point[1] + point[3],
      ...
      getXYWidthHeight: function (x, y, prevX, prevY, oldPoints) {
        return (
          ...
          "stretch-second" == oldPoints.pointsToMove &&
            ((oldPoints.width =
              x > prevX
                ? oldPoints.width + (x - prevX)
                : oldPoints.width - (prevX - x)),
            y < prevY
              ? ((oldPoints.y = oldPoints.y + (y - prevY)),
                (oldPoints.height = oldPoints.height - (y - prevY)))
              : ((oldPoints.y = oldPoints.y - (prevY - y)),
                (oldPoints.height = oldPoints.height + (prevY - y)))),
          "stretch-third" == oldPoints.pointsToMove &&
            (x > prevX
              ? ((oldPoints.x = oldPoints.x + (x - prevX)),
                (oldPoints.width = oldPoints.width - (x - prevX)))
              : ((oldPoints.x = oldPoints.x - (prevX - x)),
            ...
            (oldPoints.height =
              y < prevY
                ? oldPoints.height + (y - prevY)
                : oldPoints.height - (prevY - y))),
          oldPoints
        );
      },
      dragShape: function (x, y) {
        if (this.global.ismousedown) {
          tempContext.clearRect(0, 0, innerWidth, innerHeight),
            is.isDragLastPath && this.dragLastPath(x, y),
            is.isDragAllPaths && this.dragAllPaths(x, y);
          var g = this.global;
          (g.prevX = x), (g.prevY = y);
        }
      },
      ...
      dragLastPath: function (x, y) {
        if (points[points.length - 1]) {
          ...
          if (
            ("line" === p[0] &&
              (("head" === g.pointsToMove || isMoveAllPoints) &&
                ((point[0] = getPoint(x, prevX, point[0])),
                (point[1] = getPoint(y, prevY, point[1]))),
              ("tail" === g.pointsToMove || isMoveAllPoints) &&
          ...
          "quadratic" === p[0] &&
            (("starting-points" === g.pointsToMove || isMoveAllPoints) &&
              ((point[0] = getPoint(x, prevX, point[0])),
              (point[1] = getPoint(y, prevY, point[1]))),
            ("control-points" === g.pointsToMove || isMoveAllPoints) &&
              ((point[2] = getPoint(x, prevX, point[2])),
              (point[3] = getPoint(y, prevY, point[3]))),
            ("ending-points" === g.pointsToMove || isMoveAllPoints) &&
            ...
            "bezier" === p[0] &&
              (("starting-points" === g.pointsToMove || isMoveAllPoints) &&
                ((point[0] = getPoint(x, prevX, point[0])),
                (point[1] = getPoint(y, prevY, point[1]))),
              ("1st-control-points" === g.pointsToMove || isMoveAllPoints) &&
                ((point[2] = getPoint(x, prevX, point[2])),
                (point[3] = getPoint(y, prevY, point[3]))),
              ("2nd-control-points" === g.pointsToMove || isMoveAllPoints) &&
                ((point[4] = getPoint(x, prevX, point[4])),
                (point[5] = getPoint(y, prevY, point[5]))),
              ("ending-points" === g.pointsToMove || isMoveAllPoints) &&
    ...
    textHandler = {
      ...
      onShapeUnSelected: function () {
        (this.text = ""),
          ...
          void 0 !== this.blinkCursorInterval &&
        ...
        if (is.isText) {
          if (isBackKeyPressed)
            return (
              ...
              void textHandler.fillText(textHandler.text)
            );
      ...
      mousedown: function (e) {
        is.isText &&
          (textHandler.text.length && this.appendPoints(),
          ...
          void 0 !== textHandler.blinkCursorInterval &&
      ...
      showOrHideTextTools: function (show) {
        "hide" === show
          ? this.lastFillStyle.length &&
            ((fillStyle = this.lastFillStyle), (this.lastFillStyle = ""))
          : this.lastFillStyle.length ||
            ((this.lastFillStyle = fillStyle), (fillStyle = "black")),
      ...
      eachFontFamily: function (callback) {
        for (
          var childs = this.fontFamilyBox.querySelectorAll("li"), i = 0;
          i < childs.length;
          i++
        )
          callback(childs[i]);
      ...
      unselectAllFontFamilies: function () {
        this.eachFontFamily(function (child) {
          (child.className = ""),
            child.innerHTML === textHandler.selectedFontFamily &&
              (child.className = "font-family-selected");
        });
      },
      eachFontSize: function (callback) {
        for (
          var childs = this.fontSizeBox.querySelectorAll("li"), i = 0;
          i < childs.length;
          i++
        )
          callback(childs[i]);
      ...
      unselectAllFontSizes: function () {
        this.eachFontSize(function (child) {
          (child.className = ""),
            child.innerHTML === textHandler.selectedFontSize &&
    ...
    arcHandler = {
      ...
      mousemove: function (e) {
        ...
        if (ismousedown && !isCircleDrawn && isCircleEnded) {
          var prevX = g.prevX,
            prevY = g.prevY,
            radius = (x - prevX + (y - prevY)) / 3;
          tempContext.clearRect(0, 0, 2e3, 2e3),
      ...
      arcRangeHandler: function (e) {
        ...
        if (
          ...
          !key || 13 == key || 39 == key || 40 == key || 37 == key || 38 == key)
        ) {
  ...
  var lineHandler = {
    ...
    quadraticHandler = {
      ...
      mousedown: function (e) {
        var g = this.global,
          x = e.pageX - canvas.offsetLeft,
          y = e.pageY - canvas.offsetTop;
        g.isLastStep || ((g.prevX = x), (g.prevY = y)),
          (g.ismousedown = !0),
          g.isLastStep && g.ismousedown && this.end(x, y);
      },
      mouseup: function (e) {
        var g = this.global,
          x = e.pageX - canvas.offsetLeft,
    ...
    bezierHandler = {
      ...
      mousedown: function (e) {
        var g = this.global,
          x = e.pageX - canvas.offsetLeft,
          y = e.pageY - canvas.offsetTop;
        g.isLastStep || g.isSecondStep || ((g.prevX = x), (g.prevY = y)),
          (g.ismousedown = !0),
          g.isLastStep && g.ismousedown && this.end(x, y),
          g.ismousedown &&
            g.isSecondStep &&
      ...
      function selectFile(callback, multiple, accept) {
        ...
        (file.type = "file"),
          ...
          (file.onchange = function () {
            return multiple
              ? file.files.length
                ? void callback(file.files)
                : void console.error("No file selected.")
              : file.files[0]
    ...
    pdfHandler = {
      ...
      getPage: function (pageNumber, callback) {
        if (((pageNumber = parseInt(pageNumber) || 1), !pdfHandler.pdf))
          return (
            (pdfjsLib.disableWorker = !1),
            void pdfjsLib
              .getDocument(pdfHandler.lastPdfURL)
              .then(function (pdf) {
                (pdfHandler.pdf = pdf),
        ...
        pdf.getPage(pageNumber).then(function (page) {
          ...
          !0 === pdfHandler.removeWhiteBackground &&
            ...
            function (lastPage, width, height, numPages) {
              ...
              for (var i = 1; i <= numPages; i++) {
                ...
                (option.value = i),
                  ...
                  pdfHandler.pageNumber.toString() == i.toString() &&
                    (option.selected = !0);
              }
  ...
  !0 === tools.code &&
    ...
    (function () {
      function getContext(id) {
        ...
        return (
          (context.lineWidth = 2), (context.strokeStyle = "#6c96c8"), context
        );
      }

      function bindEvent(context, shape) {
        ("Pencil" !== shape && "Marker" !== shape) ||
          (lineCap = lineJoin = "round"),
          addEvent(context.canvas, "click", function () {
            if (
              (textHandler.text.length && textHandler.appendPoints(),
              "Text" === shape
              ...
              "drag-last-path" === this.id
                ? ((find("copy-last").checked = !0),
                  (find("copy-all").checked = !1))
                : "drag-all-paths" === this.id &&
                  ((find("copy-all").checked = !0),
                  (find("copy-last").checked = !1)),
              "image-icon" === this.id)
            ) {
            ...
            "marker-icon" === this.id
              ...
              : cache.lineCap &&
                cache.lineJoin &&
                ((lineCap = cache.lineCap), (lineJoin = cache.lineJoin)),
              "eraser-icon" === this.id
        ...
        (image.onload = function () {
          context.drawImage(image, 4, 4, 32, 32),
            (document.querySelector("#undo").onclick = function () {
              points.length &&
                ((points.length = points.length - 1), drawHelper.redraw()),
                syncPoints(!0);
            });
        }),
      ...
      (find("tool-box").style.height = innerHeight + "px"),
        ...
        !0 === tools.colorsPicker &&
          (decorateColors(),
          (document.getElementById("colors").style.display = "block")),
        !0 === tools.extraOptions &&
      ...
      addEvent(find("is-shorten-code"), "change", common.updateTextArea),
  ...
  addEvent(canvas, isTouch ? "touchstart mousedown" : "mousedown", function (
    ...
    cache.isLine
      ...
      : cache.isDragLastPath || cache.isDragAllPaths
      ...
      : cache.isImage
      ? imageHandler.mousedown(e)
      : cache.isPdf
      ? pdfHandler.mousedown(e)
      : cache.isArrow
      ? arrowHandler.mousedown(e)
      : cache.isMarker && markerHandler.mousedown(e),
    ...
    addEvent(
      ...
      function (e) {
        ...
        var cache = is;
        cache.isLine
          ? lineHandler.mouseup(e)
          : cache.isArc
          ? arcHandler.mouseup(e)
          : cache.isRectangle
          ? rectHandler.mouseup(e)
          : cache.isQuadraticCurve
          ? quadraticHandler.mouseup(e)
          : cache.isBezierCurve
          ? bezierHandler.mouseup(e)
          : cache.isDragLastPath || cache.isDragAllPaths
          ...
          : cache.isImage
          ? imageHandler.mouseup(e)
          : cache.isPdf
          ? pdfHandler.mousedown(e)
          : cache.isArrow
          ? arrowHandler.mouseup(e)
          : cache.isMarker && markerHandler.mouseup(e),
          !cache.isPdf && drawHelper.redraw(),
          syncPoints(!(!is.isDragAllPaths && !is.isDragLastPath)),
          preventStopEvent(e);
      }
    ...
    addEvent(canvas, isTouch ? "touchmove mousemove" : "mousemove", function (
      ...
      var cache = is;
      cache.isLine
        ? lineHandler.mousemove(e)
        : cache.isArc
        ? arcHandler.mousemove(e)
        : cache.isRectangle
        ? rectHandler.mousemove(e)
        : cache.isQuadraticCurve
        ? quadraticHandler.mousemove(e)
        : cache.isBezierCurve
        ? bezierHandler.mousemove(e)
        : cache.isDragLastPath || cache.isDragAllPaths
        ? dragHelper.mousemove(e)
        : cache.isPencil
        ? pencilHandler.mousemove(e)
        : cache.isEraser
        ? eraserHandler.mousemove(e)
        : cache.isText
        ? textHandler.mousemove(e)
        : cache.isImage
        ? imageHandler.mousemove(e)
        : cache.isPdf
        ? pdfHandler.mousedown(e)
        : cache.isArrow
        ? arrowHandler.mousemove(e)
        : cache.isMarker && markerHandler.mousemove(e),
        preventStopEvent(e);
    });
  var keyCode;
  //추가
  ...
  window.addEventListener(
    ...
    function (event) {
      if (event.data) {
        if ((uid || (uid = event.data.uid), event.data.captureStream))
          return void webrtcHandler.createOffer(function (sdp) {
        ...
        if (event.data.sdp)
          return void webrtcHandler.setRemoteDescription(event.data);
        ...
        if (event.data.undo && points.length) {
          ...
          if (points[index]) {
            for (var newPoints = [], i = 0; i < points.length; i++)
              i !== index && newPoints.push(points[i]);
          ...
          if (event.data.clearCanvas)
            return (points = []), void drawHelper.redraw();
